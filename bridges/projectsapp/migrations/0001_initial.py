# Generated by Django 2.2.5 on 2019-10-06 17:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contractor', models.CharField(blank=True, max_length=512, null=True, verbose_name='подрядчик')),
                ('customer', models.CharField(blank=True, max_length=512, null=True, verbose_name='заказчик')),
                ('designer', models.CharField(blank=True, max_length=512, null=True, verbose_name='проектировщик')),
            ],
            options={
                'verbose_name': 'Проект',
